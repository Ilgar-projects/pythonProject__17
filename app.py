...
data = {
    "movies": [{
        ...
        "title": "Дюна",
        "description": "Наследник знаменитого дома Атрейдесов Пол отправляется вместе с семьей на одну из планет.",
        ...
        "title": "Лето",
        "description": "Рассказ о начале творческого пути Виктора Цоя и группы «Кино». ",
        ...
        "title": "Сияние ",
        "description": "Джек Торренс с женой и сыном приезжает в элегантный отдалённый отель.",
        ...
        "title": "Веном",
        "description": "Что если в один прекрасный день в тебя вселяется существо-симбиот.",
        ...
        "title": "Донни Дарко",
        "description": "К своим 16 годам старшеклассник Донни уже знает, что такое смерть.",
        ...
        "description": "Париж. 1910 год. Ужасный монстр, напоминающий гигантское насекомое.",
...
class MovieSchema(Schema):
    ...
    genre = fields.Nested(GenreSchema)  # возвращает список словарей из таблицы GenreSchema
    director_id = fields.Integer()
    director = fields.Pluck(field_name="name", nested=DirectorSchema)  # частный случай Nested
